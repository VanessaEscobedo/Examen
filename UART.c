...
/*Si me toca el UART2
GPIOF->LOCK = 0x4C4F434B (el numero siempre es el mismo, se pone el puerto que se quiere desbloquear)
GPIOF->CR = 0x1F (para indicar que pines queremos desbloquear)
*/
